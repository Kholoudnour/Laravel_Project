...
<head>
	...
	<link
		...
		rel="stylesheet">
	<link rel="stylesheet" href="{{asset('admin/assests/css/dataTables.dataTables.min.css')}}">
	<link rel="stylesheet" href="{{asset('admin/assests/css/main.min.css')}}">
	<link rel="stylesheet" href="{{asset('admin/assests/css/styles.css')}}">
</head>
			...
			<div class="col-md-7">
				...
				<h3 class="fw-semibold mb-5">REGISERTATION FORM</h3>
					...
					<div class="input-group mb-3">
						...
						<img src="{{asset('admin/assests/images/user-svgrepo-com.svg')}}" alt="" class="input-group-text">
					</div>
					<div class="input-group  mb-3">
					...
					<div class="input-group mb-3">
						...
						<img src="{{asset('admin/assests/images/password-svgrepo-com.svg')}}" alt="" class="input-group-text">
					</div>
					...
					<button class="btn btn-dark px-5 mb-2">
						REGISTER
						<img src="{{asset('admin/assests/images/arrow-sm-right-svgrepo-com.svg')}}" alt="">
					</button>
