...
@include('admin.includes.header')
          ...
          <div class="col-md-5">
          <input type="text"name="firstname" placeholder="First Name" class="form-control py-2"value="{{old('firstname')}}" />
            @error('firstname')
					<div class="alert alert-warning">{{$message}}</div>
						@enderror
          </div>
          <div class="col-md-5">
          <input type="text" name="lastname"placeholder="Last Name" class="form-control py-2" value="{{old('lastname')}}"/>
            @error('lastname')
					<div class="alert alert-warning">{{$message}}</div>
						@enderror
          </div>
          ...
          <div class="col-md-10">
            <input type="email" name="email" placeholder="e.g. Jhon@example.com" class="form-control py-2"value="{{old('email')}}" />
            @error('email')
						<div class="alert alert-warning">{{$message}}</div>
						@enderror
          </div>
          ...
          <div class="col-md-10">
            <input type="phone" name="phone" placeholder="01xxxxxxxxx" class="form-control py-2"value="{{old('phone')}}" />
            @error('phone')
						<div class="alert alert-warning">{{$message}}</div>
						@enderror
          </div>
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <input type="password" name="password"placeholder="Password" class="form-control py-2"value="{{old('password')}}" />
            @error('password')
						<div class="alert alert-warning">{{$message}}</div>
						@enderror
          </div>
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <input type="password" name="password" placeholder="Confirm Password" class="form-control py-2"value="{{old('password')}}" />
            @error('password')
						<div class="alert alert-warning">{{$message}}</div>
						@enderror
          </div>
